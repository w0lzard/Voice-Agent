...
export default function VoicePage() {
  ...
  const handleTestCall = async () => {
    if (!testPhone.trim()) {
      setCallError('Enter a phone number');
      return;
    }
  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-slate-500 mt-0.5">
            Configure AI voice characteristics for your agents
          </p>
        </div>
        <button
              ...
              return (
                <div
                  ...
                  style={
                    isActive
                      ? {
                          boxShadow: '0 0 0 1px rgba(43,108,238,0.2)',
        ...
        <div className="lg:col-span-5 space-y-5">
          ...
          >
            <div
              ...
              style={{
                background:
                  'radial-gradient(circle at center, rgba(43,108,238,0.6), transparent 60%)',
              }}
            ></div>
            ...
            <div
              className={`flex items-end justify-center gap-1 h-24 mb-5 relative z-10 w-full ${
                isPlaying ? 'wave-playing' : ''
              }`}
            >
              {[...Array(24)].map((_, i) => {
            ...
            <div className="relative z-10">
              ...
              <p
                className={`text-sm text-slate-300 italic transition-opacity ${
                  isPlaying ? 'opacity-100' : 'opacity-40'
                }`}
              >
                &quot;Hello, I&apos;m{' '}
                {VOICES.find((v) => v.id === activeVoice)?.name.split('—')[1]?.trim()} from
                VoiceAI. How can I help you?&quot;
              </p>
            </div>
          </div>
            ...
            {[
              {
                ...
                desc: 'How consistent the voice is across responses.',
              },
              {
                label: 'Clarity + Similarity',
                value: clarity,
                onChange: setClarity,
                desc: 'Higher values = clearer but less emotional.',
              },
            ].map((ctrl) => (
      ...
      <div
        ...
        style={{
          background:
            'linear-gradient(135deg, rgba(43,108,238,0.07), rgba(139,92,246,0.04))',
        }}
      >
        ...
        <div className="relative z-10 p-6 grid grid-cols-1 lg:grid-cols-3 gap-8 items-center">
          ...
          <div className="lg:col-span-1 space-y-3">
            ...
            <p className="text-xs text-slate-400 leading-relaxed">
              Record a short 60-second clip and our AI will model your vocal tone, pitch, and
              cadence — making every agent call sound unmistakably like you.
            </p>
            {isRecording && (
          ...
          <div className="lg:col-span-1 grid grid-cols-3 gap-3">
            {[
              ...
              <div
                key={step.n}
                className="flex flex-col items-center text-center gap-2 px-2 py-3 rounded-xl border border-white/5"
          ...
          <div className="lg:col-span-1 flex flex-col items-center gap-4">
            <div
              className={`flex items-end justify-center gap-1 h-14 w-full ${
                isRecording ? 'wave-playing' : ''
              }`}
            >
              {[...Array(28)].map((_, i) => {
                const h = [
                  20, 50, 80, 100, 70, 40, 90, 60, 30, 85, 100, 55, 35, 75, 100, 65, 45, 90, 50,
                  30, 80, 100, 60, 40, 70, 95, 45, 25,
                ][i % 28];
                return (
                  <div
                    key={i}
            ...
            <button
              ...
              style={{
                boxShadow: isRecording
                  ...
                  : '0 4px 20px rgba(43,108,238,0.35)',
              }}
            >
              {isRecording && (
                <span className="absolute inset-0 bg-red-600 animate-pulse opacity-30 rounded-xl"></span>
              )}
      ...
      >
        ...
        <div
          ...
          style={{
            background:
              'linear-gradient(135deg, rgba(43,108,238,0.06), rgba(139,92,246,0.04))',
          }}
        >
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-[11px] text-slate-500 mt-0.5">
                Dispatch a live call to any number and verify your agent is working
              </p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-5">
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                <span className="material-symbols-outlined absolute left-3 top-1/2 -translate-y-1/2 text-slate-600 text-[18px] pointer-events-none">
                  smart_toy
                </span>
                <select
                  value={selectedAgent}
              ...
              <p className="text-[10px] text-slate-600">
                Select which agent handles this call
              </p>
            </div>
            ...
            <div className="space-y-1.5">
              ...
              <p className="text-[10px] text-slate-600">
                E.164 format recommended (+countrycode…)
              </p>
            </div>
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                <span className="material-symbols-outlined absolute left-3 top-4 text-slate-600 text-[18px] pointer-events-none">
                  edit_note
                </span>
              ...
              <p className="text-[10px] leading-4 text-slate-600 px-1">
            ...
            <div className="mt-5 flex items-center gap-4 px-5 py-4 rounded-xl border border-emerald-500/20 bg-emerald-500/5">
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-xs text-slate-500 mt-0.5">
                  Call ID:{' '}
                  <span className="font-mono text-slate-400">{callResult.call_id}</span>
                  &nbsp;·&nbsp;Status:{' '}
              ...
              <button
                onClick={resetCall}
                className="shrink-0 size-8 rounded-lg flex items-center justify-center text-slate-500 hover:bg-white/5 hover:text-slate-300 transition-all"
              >
            ...
            <button
              ...
              style={{
                ...
                boxShadow:
                  callStatus === 'calling'
                    ? 'none'
                    : '0 4px 16px rgba(43,108,238,0.35)',
              }}
            >
              {callStatus === 'calling' ? (
                <>
